...
from src.app.application.hh.auth.dto import HeadHunterUserDTO, OauthTokenDTO
from src.app.application.hh.auth.oauth import HHOAuthService
from src.app.application.users.auth.dto import JWTEntity, JWTPairDTO, JWTType
